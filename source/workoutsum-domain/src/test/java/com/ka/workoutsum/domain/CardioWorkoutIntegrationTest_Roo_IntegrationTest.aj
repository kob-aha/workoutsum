...
import com.ka.workoutsum.domain.CardioWorkoutIntegrationTest;
...
privileged aspect CardioWorkoutIntegrationTest_Roo_IntegrationTest {
    
    declare @type: CardioWorkoutIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: CardioWorkoutIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext*.xml");
    
    declare @type: CardioWorkoutIntegrationTest: @Transactional;
    
    @Autowired
    private CardioWorkoutDataOnDemand CardioWorkoutIntegrationTest.dod;
    
    @Test
    public void CardioWorkoutIntegrationTest.testCountCardioWorkouts() {
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testFindCardioWorkout() {
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testFindAllCardioWorkouts() {
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", dod.getRandomCardioWorkout());
        long count = CardioWorkout.countCardioWorkouts();
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testFindCardioWorkoutEntries() {
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", dod.getRandomCardioWorkout());
        long count = CardioWorkout.countCardioWorkouts();
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testFlush() {
        CardioWorkout obj = dod.getRandomCardioWorkout();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to provide an identifier", id);
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testMergeUpdate() {
        CardioWorkout obj = dod.getRandomCardioWorkout();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to provide an identifier", id);
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", dod.getRandomCardioWorkout());
    ...
    @Test
    public void CardioWorkoutIntegrationTest.testRemove() {
        CardioWorkout obj = dod.getRandomCardioWorkout();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CardioWorkout' failed to provide an identifier", id);
