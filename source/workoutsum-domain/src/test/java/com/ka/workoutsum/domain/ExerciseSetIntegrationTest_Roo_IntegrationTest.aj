...
import com.ka.workoutsum.domain.ExerciseSetIntegrationTest;
...
privileged aspect ExerciseSetIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ExerciseSetIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ExerciseSetIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ExerciseSetIntegrationTest: @Transactional;
    
    @Autowired
    private ExerciseSetDataOnDemand ExerciseSetIntegrationTest.dod;
    
    @Test
    public void ExerciseSetIntegrationTest.testCountExerciseSets() {
    ...
    @Test
    public void ExerciseSetIntegrationTest.testFindExerciseSet() {
    ...
    @Test
    public void ExerciseSetIntegrationTest.testFindAllExerciseSets() {
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", dod.getRandomExerciseSet());
        long count = ExerciseSet.countExerciseSets();
    ...
    @Test
    public void ExerciseSetIntegrationTest.testFindExerciseSetEntries() {
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", dod.getRandomExerciseSet());
        long count = ExerciseSet.countExerciseSets();
    ...
    @Test
    public void ExerciseSetIntegrationTest.testFlush() {
        ExerciseSet obj = dod.getRandomExerciseSet();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to provide an identifier", id);
    ...
    @Test
    public void ExerciseSetIntegrationTest.testMergeUpdate() {
        ExerciseSet obj = dod.getRandomExerciseSet();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to provide an identifier", id);
    ...
    @Test
    public void ExerciseSetIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", dod.getRandomExerciseSet());
    ...
    @Test
    public void ExerciseSetIntegrationTest.testRemove() {
        ExerciseSet obj = dod.getRandomExerciseSet();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ExerciseSet' failed to provide an identifier", id);
